      ...
      <Box
        ...
        <FormControl style={{ width: "400px", backgroundColor: "#F5F5F5", borderRadius: "10px", padding: "100px" }}>
          ...
          <FormGroup value={workRight}>
            <FormControlLabel control={<Checkbox />} label="Monday" value={1} checked={workRight && workRight.some((item) => item == "1")} onChange={handleCheckbox1} />
            <FormControlLabel control={<Checkbox />} label="Tuesday" value={2} checked={workRight && workRight.some((item) => item == "2")} onChange={handleCheckbox1} />
            <FormControlLabel control={<Checkbox />} label="Wenesday" value={3} checked={workRight && workRight.some((item) => item == "3")} onChange={handleCheckbox1} />
            <FormControlLabel control={<Checkbox />} label="Thursday" value={4} checked={workRight && workRight.some((item) => item == "4")} onChange={handleCheckbox1} />
            <FormControlLabel control={<Checkbox />} label="Friday" value={5} checked={workRight && workRight.some((item) => item == "5")} onChange={handleCheckbox1} />
            <FormControlLabel control={<Checkbox />} label="Saturday" value={6} checked={workRight && workRight.some((item) => item == "6")} onChange={handleCheckbox1} />
            <FormControlLabel control={<Checkbox />} label="Sunday" value={7} checked={workRight && workRight.some((item) => item == "7")} onChange={handleCheckbox1} />
          </FormGroup>
          <br></br>
          <FormLabel style={{ fontWeight: "bold", color: "black" }}>Project Intention</FormLabel>
          <FormGroup value={intention}>
            <FormControlLabel control={<Checkbox />} label="Information Technology" value={1} checked={intention && intention.some((item) => item == "1")} onChange={handleCheckbox2} />
            <FormControlLabel control={<Checkbox />} label="Accounting" value={2} checked={intention && intention.some((item) => item == "2")} onChange={handleCheckbox2} />
            <FormControlLabel control={<Checkbox />} label="Banking" value={3} checked={intention && intention.some((item) => item == "3")} onChange={handleCheckbox2} />
            <FormControlLabel control={<Checkbox />} label="Engineering" value={4} checked={intention && intention.some((item) => item == "4")} onChange={handleCheckbox2} />
            <FormControlLabel control={<Checkbox />} label="Sport" value={5} checked={intention && intention.some((item) => item == "5")} onChange={handleCheckbox2} />
            <FormControlLabel control={<Checkbox />} label="Business" value={6} checked={intention && intention.some((item) => item == "6")} onChange={handleCheckbox2} />
            <FormControlLabel control={<Checkbox />} label="Media" value={7} checked={intention && intention.some((item) => item == "7")} onChange={handleCheckbox2} />
          </FormGroup>
          <br></br>
