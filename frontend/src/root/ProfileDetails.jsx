                ...
                <TableContainer component={Paper} style={{ border: "2px solid #c0c0c0" }}>
                    <Table>
                        ...
                        <TableRow>
                            ...
                            <TableCell>{Array.isArray(profileDetails.work_rights) ? profileDetails.work_rights.join(', ') : ''}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell>Project Intention:</TableCell>
                            <TableCell>{Array.isArray(profileDetails.project_intention) ? profileDetails.project_intention.join(', ') : ''}</TableCell>
                        </TableRow>
                        <TableRow>
